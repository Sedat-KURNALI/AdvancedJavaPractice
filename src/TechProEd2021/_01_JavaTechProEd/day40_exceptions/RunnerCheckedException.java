...
public class RunnerCheckedException {
	...
	public static void main(String[] args) throws InvalidEmailIdCheckedException {
		 ...
		 * Exception in thread "main" _duzenle.TechProEd2021._01_JavaTechProEd.day40_exceptions.InvalidEmailIdCheckedException: email uygun de�il
		at NewDay/_duzenle.TechProEd2021._01_JavaTechProEd.day40_exceptions.RunnerCheckedException.mailDogrula(RunnerCheckedException.java:19)
		at NewDay/_duzenle.TechProEd2021._01_JavaTechProEd.day40_exceptions.RunnerCheckedException.main(RunnerCheckedException.java:8)
		*/
	}
